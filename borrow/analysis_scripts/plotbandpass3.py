...
#
PLOTBANDPASS_REVISION_STRING = "$Id: plotbandpass3.py,v 1.148 2014/12/04 21:12:51 thunter Exp $" 
import pylab as pb
...
def version(showfile=True):
    ...
    """
    myversion = "$Id: plotbandpass3.py,v 1.148 2014/12/04 21:12:51 thunter Exp $" 
    if (showfile):
...
#          print "redisplay = True"
     ...
     bbctr += 1
    # end of while(bbctr or spwctr) loop
...
def SetNewYLimits(newylimits):
    if (False): print "Entered SetNewYLimits with ", newylimits 
